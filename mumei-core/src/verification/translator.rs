...
pub(crate) use z3_types::{
    ...
    array_element_type_name, array_len_value, as_bv_i64, as_int_like, atom_stores_to_array,
    coerce_array_store_value, coerce_to_array_elem_sort, coerce_to_float, concrete_len_value,
    float_eq, float_from_f64, havoc_array_args, havoc_array_name, index_in_bounds,
    is_admissible_trigger, is_bv_i64, mark_string_constraints, merge_arm_env_into,
