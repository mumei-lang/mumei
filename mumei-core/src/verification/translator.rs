...
pub(crate) use z3_types::{
    ...
    coerce_array_store_value, coerce_to_array_elem_sort, coerce_to_float, float_eq, float_from_f64,
    havoc_array_args, havoc_array_name, index_in_bounds, is_admissible_trigger, is_bv_i64,
    mark_string_constraints, merge_arm_env_into, merge_branch_envs, param_z3_value, real_from_f64,
