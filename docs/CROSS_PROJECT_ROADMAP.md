...
| ✅ | SI-6 / Lean fallback unknown-obligation bridge | mumei + mumei-lean | Implemented (live generated paths: `abs_saturating`, `bounded_mul_with_overflow_check`, `constant_time_eq_flag`) |
