...
11. widening the benchmark-to-forge feedback channel: the `mumei.benchmark_forge_feedback/v1` priority bias is implemented, but proposal *generation* (not just ordering) is not yet derived from benchmark weakness;
